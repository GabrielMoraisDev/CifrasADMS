...
const Lista = ({ link }) => {
  ...
  return (
    <div className='mt-36 flex flex-col items-center mx-4'>
      <input
        type="text"
        className="left-4 fixed z-10 bg-cyan-950 top-24 text-cyan-100 border border-2 border-cyan-800 rounded p-2 mb-4 w-[92%] uppercase mx-auto"
        ...
        {filteredData.map(item => (
          <li key={item.id}>
            <div className="flex relative my-3 overflow-hidden">
              <Link href={link+'/'+String(item.id)} className='flex'>
                <div className='w-12 h-10 flex justify-center items-center m-auto text-center bg-cyan-800 text-xl mr-2 rounded-md overflow-hidden'>{item.tom}</div>
              ...
              <Link href={link+'/'+String(item.id)} className='absolute right-10 top-1 flex justify-center items-center'>
              ...
              <Link href={link+'/'+String(item.id)} className='absolute right-0 top-1 flex justify-center items-center'>
                <div className='w-8 h-8 flex bg-cyan-800 text-xl rounded-md justify-center items-center '>
