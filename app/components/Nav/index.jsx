...
export default function Nav() {
    ...
    // Função para determinar a classe do SVG com base na rota
    ...
    return(
        ...
        <Link href='saved'>
        <div className="w-14 h-14 mx-3 rounded-md flex justify-center place-items-center"> 
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className={`bi bi-bookmarks ${getSvgClass('/saved')}`} viewBox="0 0 16 16">
        ...
        <Link href='user'>
        <div className="w-14 h-14 mx-3 rounded-md flex justify-center place-items-center"> 
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className={`bi bi-person ${getSvgClass('/user')}`} viewBox="0 0 16 16">
