...
export default function Item({ id, consul }: ItemProps) {
  ...
  const substitutions: Record<string, Record<string, string>> = {
    ...
    'C#': { 'C': 'C#', 'D': 'D#', 'Dm': 'D#m', 'E': 'F', 'Em': 'Fm', 'F': 'F#', 'G': 'G#', 'A': 'Bb', 'Am': 'Bbm', 'Bb': 'B', 'B°': 'C°' },
    'D': { 'C': 'D', 'D': 'E', 'Dm': 'Em', 'E': 'F#', 'Em': 'F#m', 'F': 'G', 'G': 'A', 'A': 'B', 'Am': 'Bm', 'Bb': 'C', 'B°': 'C#°' },
    'D#': { 'C': 'D#', 'D': 'F', 'Dm': 'Fm', 'E': 'G', 'Em': 'Gm', 'F': 'G#', 'G': 'Bb', 'A': 'C', 'Am': 'Cm', 'Bb': 'C#', 'B°': 'D°' },
    'E': { 'C': 'E', 'D': 'F#', 'Dm': 'F#m', 'E': 'G#', 'Em': 'G#m', 'F': 'A', 'G': 'B', 'A': 'C#', 'Am': 'C#m', 'Bb': 'D', 'B°': 'D#°' },
    'F': { 'C': 'F', 'D': 'G', 'Dm': 'Gm', 'E': 'A', 'Em': 'Am', 'F': 'Bb', 'G': 'C', 'A': 'D', 'Am': 'Dm', 'Bb': 'Eb', 'B°': 'E°' },
    'F#': { 'C': 'F#', 'D': 'G#', 'Dm': 'G#m', 'E': 'Bb', 'Em': 'Bbm', 'F': 'B', 'G': 'C#', 'A': 'D#', 'Am': 'D#m', 'Bb': 'E', 'B°': 'F°' },
    'G': { 'C': 'G', 'D': 'A', 'Dm': 'Am', 'E': 'B', 'Em': 'Bm', 'F': 'C', 'G': 'D', 'A': 'E', 'Am': 'Em', 'Bb': 'F', 'B°': 'F#°' },
    'G#': { 'C': 'G#', 'D': 'Bb', 'Dm': 'Bbm', 'E': 'C', 'Em': 'Cm', 'F': 'C#', 'G': 'D#', 'A': 'F', 'Am': 'Fm', 'Bb': 'F#', 'B°': 'G°' },
    'A': { 'C': 'A', 'D': 'B', 'Dm': 'Bm', 'E': 'C#', 'Em': 'C#m', 'F': 'D', 'G': 'E', 'A': 'F#', 'Am': 'F#m', 'Bb': 'G', 'B°': 'G#°' },
    'Bb': { 'C': 'Bb', 'D': 'C', 'Dm': 'Cm', 'E': 'D', 'Em': 'Dm', 'F': 'D#', 'G': 'F', 'A': 'G', 'Am': 'Gm', 'Bb': 'G#', 'B°': 'A°' },
    'B': { 'C': 'B', 'D': 'C#', 'Dm': 'C#m', 'E': 'D#', 'Em': 'D#m', 'F': 'E', 'G': 'F#', 'A': 'G#', 'Am': 'G#m', 'Bb': 'A', 'B°': 'Bb°' }
  };
    ...
    return (
      <div>
        {lines.map((line, index) => (
          <div key={index}>
            <p className="mt-6">{cifra(tom, cifras[index] || '')}</p>
            <p>{line}</p>
          </div>
        ))}
      </div>
